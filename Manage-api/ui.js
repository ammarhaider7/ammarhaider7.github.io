                      ...
                      success: function(response) {
                                  o[r_l].tags = response;
								   ...
								   var dependencies = el.dependentDeployments;
										...
										$(selector).append('<tr class="tag ' + id + '"><td>' + name + '</td><td><table><tr class="executionTime"><td><u>Execution time: </u></td><td class="exec">' + exec + '</td></tr><tr class="lastAction"><td><u>Last action: </u></td><td class="last-act">' + lastAct + '</td></tr><tr class="modifyDate"><td><u>Last modified: </u></td><td class="last-mod">' + lastMod + '</td></tr><tr class="conditionIds"><td><u>Conditions: </u></td><td class="cond">' + conditions + '</td></tr><tr class="dependentDeployments"><td><u>Dependencies: </u></td><td class="depend">' + dependencies + '</td></tr><tr class="comments"><td><u>Comments: </u></td><td class="comm">' + comments + '</td></tr></table></td></tr><tr class="status"><td><u>Status: </u></td><td class="status">' + status + '</td></tr></td></tr></table></td></tr>');
