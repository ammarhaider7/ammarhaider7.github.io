...
Realtime.Models.orderTable = Backbone.Model.extend({
  ...
  params: Realtime.api.params('orders', 'prop17', '-12 hours', 100)
});
...
Realtime.Models.orderTotal = Backbone.Model.extend({
  ...
  params: (function() {
    return Realtime.api.params('orders', 'prop17', '-12 hours');
  })()
});
// Generated by CoffeeScript 1.9.3
Realtime.Models.pageViewBreakdown = Backbone.Model.extend({
  ...
  params: (function() {
    return Realtime.api.params('event1', 'page', '-12 hours', 10);
  })()
});
// Generated by CoffeeScript 1.9.3
Realtime.Models.pageViewTotals = Backbone.Model.extend({
  ...
  params: (function() {
    ...
    return Realtime.api.params('event1', 'page', '-12 hours', 10, search);
  })()
});
